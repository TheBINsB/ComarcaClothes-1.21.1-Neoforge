package net.elbin.comarcaclothes.client.model.head;// Made with Blockbench 5.1.3
...
public class doubletophat<T extends LivingEntity> extends EntityModel<T> implements IHeadModel {
