...
public class librarian<T extends LivingEntity> extends EntityModel<T> implements IHeadModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			ResourceLocation.fromNamespaceAndPath(ComarcaClothes.MOD_ID, "librarian"), "main");

	private final ModelPart root;
	private final ModelPart bipedHead;

	public librarian(ModelPart root) {
		this.root = root;
