...
public class swamp<T extends LivingEntity> extends EntityModel<T> implements IHeadModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			ResourceLocation.fromNamespaceAndPath(ComarcaClothes.MOD_ID, "swamp"), "main");

	private final ModelPart root;
	private final ModelPart bipedHead;

	public swamp(ModelPart root) {
		this.root = root;
